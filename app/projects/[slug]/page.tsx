        ...
        <main className="max-w-6xl mx-auto px-6 py-20 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12 border-t border-zinc-800 pt-16">
                <div className="md:col-span-4">
                    <h1 className="font-mono text-4xl font-black mb-4 text-white">{title.rendered}</h1>
                    <div className="h-1 w-20 bg-blue-600 mb-8" />
                    <p className="font-mono text-sm text-zinc-500 uppercase tracking-widest font-bold">Project Details</p>
                    <p className="text-zinc-400 mt-2">{acf.project_description}</p>
                </div>

                <div className="md:col-span-8 space-y-16">
                    <section>
                        <h2 className="font-mono text-xl font-bold text-white mb-4 uppercase tracking-tighter">The Problem</h2>
                        <RenderContent html={acf.problem} />
                    </section>
                    
                    <section>
                        <h2 className="font-mono text-xl font-bold text-blue-600 mb-4 uppercase tracking-tighter">The Solution</h2>
                        <RenderContent html={acf.solution} />
                    </section>

                    <section>
                        <h2 className="font-mono text-xl font-bold text-blue-600 mb-4 uppercase tracking-tighter">Results & Impact</h2>
